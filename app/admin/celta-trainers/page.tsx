    ...
    try {
      ...
      if (errorMessage.includes("permission") || errorMessage.includes("Permission")) {
        setError(
          ...
          "See docs/firestore.rules.txt for the correct rules."
        );
      } else {
          ...
          {error.includes("Permission") && (
            <div className="mt-3 text-sm">
              ...
              <ol className="list-decimal list-inside space-y-1 ml-2">
                ...
                <li>Copy the rules from <code className="bg-red-100 px-1 rounded">docs/firestore.rules.txt</code></li>
...
export default function AdminCeltaTrainersPage() {
  return (
    <AdminAuthGuard>
      <CeltaTrainersManager />
    </AdminAuthGuard>
  );
}
