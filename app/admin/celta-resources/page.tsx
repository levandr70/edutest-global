...
function CeltaResourcesManager() {
  ...
  const loadResources = async () => {
    try {
      ...
      if (errorMessage.includes("permission") || errorMessage.includes("Permission")) {
        setError(
          "Permission denied. Please ensure Firestore security rules include the 'celtaResources' collection."
        );
      } else {
    ...
    try {
      ...
      if (editingId) {
        ...
        if (selectedFile) {
          ...
          // Step 3: Update Firestore doc with file info
...
export default function AdminCeltaResourcesPage() {
  return (
    <AdminAuthGuard>
      <CeltaResourcesManager />
    </AdminAuthGuard>
  );
}
